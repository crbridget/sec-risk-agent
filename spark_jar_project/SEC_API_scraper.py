...
# get first CIK (microsoft)
cik = companyData[0:1].cik_str[0]

# get company specific filing medata
...
print(filingMetaData.json()['filings'])
print(filingMetaData.json()['filings'].keys())
